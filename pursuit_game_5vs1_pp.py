...
def gut_pursuit_game():
    ...
    pursuer2_energy_label = r.axes.text(x[0,2],x[1,2]+0.2,"NRG: ",fontsize=font_size2, color='c',fontweight='bold',horizontalalignment='center',verticalalignment='center',zorder=0)
    pursuer2_hp_label = r.axes.text(x[0,2],x[1,2]+0.15,"Dist: ",fontsize=font_size2, color='m',fontweight='bold',horizontalalignment='center',verticalalignment='center',zorder=0)
    ...
    for k in range(iterations):
        ...
        # if (np.array(pursuer_evader_distance) <= 4).all():
