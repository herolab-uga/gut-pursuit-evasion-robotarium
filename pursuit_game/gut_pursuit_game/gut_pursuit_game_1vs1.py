...
def gut_pursuit_game():
    ...
    initial_conditions = np.array([[1.333, -1.4],[0.830, -0.8],[0, 1]])
    ...
    pursuer1_label = r.axes.text(x[0,1],x[1,1]+0.25,"pursuer",fontsize=font_size1, color='b',fontweight='bold',horizontalalignment='center',verticalalignment='center',zorder=0)
    ...
    for k in range(iterations):
        ...
        if (pursuer_evader_distance[1]) / 1 <= 3.3 or agent_energy_level[0] <= 0:
            tmpe = 0
